    	...
    	<div class="modal-dialog">
        	<div class="modal-content">
            	<div class="modal-body">
                    <div id="ProductSection-product" class="product__container prstyle1">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="product-details-img">
                            <div class="pl-20">
                                <img src="{{ asset('user_assets/images/product-detail-page/camelia-reversible-big1.jpg')}}" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="product-single__meta">
                                ...
                                <p class="product-single__price product-single__price">
                                    ...
                                    <s id="ComparePrice-product"><span class="money">£600.00</span></s>
                                    <span class="product-price__price  product-price__sale product-price__sale--single">
                                        <span id="ProductPrice"><span class="money">£500.00</span></span>
                                    </span>
                                </p>
                                <div class="product-single__description rte">
                                    Lorem Ipsum that will give you and your customers a smooth shopping experience which can be used for various kinds of stores such as fashion,...
                                </div>
                                
                            <form method="post" action="http://annimexweb.com/cart/add" id="product_form_10508262282" accept-charset="UTF-8" class="product-form product-form hidedropdown" enctype="multipart/form-data">
	...
	<div class="newsletter-wrap" id="popup-container">
      <div id="popup-window">
        ...
        <div class="display-table splash-bg">
          <div class="display-table-cell width40"><img src="{{ asset('user_assets/images/newsletter-img.jpg')}}" alt="Join Our Mailing List" title="Join Our Mailing List" /> </div>
	...
	<!-- End Newsletter Popup -->
     ...
     <!-- Including Jquery -->
     <script src="{{ asset('user_assets/js/vendor/jquery-3.3.1.min.js')}}"></script>
     <script src="{{ asset('user_assets/js/vendor/modernizr-3.6.0.min.js')}}"></script>
     <script src="{{ asset('user_assets/js/vendor/jquery.cookie.js')}}"></script>
     <script src="{{ asset('user_assets/js/vendor/wow.min.js')}}"></script>
     ...
     <script src="{{ asset('user_assets/js/lazysizes.js')}}"></script>
