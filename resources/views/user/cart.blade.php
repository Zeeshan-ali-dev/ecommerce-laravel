              ...
              <form action="#" method="post" class="cart style2">
                    ...
                    >
                      <td class="cart__image-wrapper cart-flex-item">
                        <a href="#"
                          ><img
                            class="cart__image"
                            src="assets/images/wallpapers/10.jpg"
                            alt=""
                        /></a>
                      </td>
                      <td class="cart__meta small--text-left cart-flex-item">
                        <div class="list-view-item__title">
                          <a href="#">Wallpaper 01 </a>
                        </div>
                ...
                <div id="shipping-calculator" class="mb-4">
                  ...
                  <div class="row">
                    ...
                    <div
                      class="col-12 col-sm-12 col-md-12 actionRow text-center"
                    >
                      <div>
                        <input
                          type="button"
                          class="btn btn--secondary get-rates"
              ...
              <div class="solid-border">
                <div class="row">
                  ...
                  <span
                    ...
                    ><span class="money">£735.00</span></span
                  >
                </div>
