                    ...
                    <div class="zoompro-wrap product-zoom-right pl-20">
                      <div class="zoompro-span">
                        <img
                          ...
                          data-zoom-image="assets/images/wallpapers/5.jpg"
                          alt=""
                          src="assets/images/wallpapers/5.jpg"
                        />
                      </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                  <div class="product-single__meta">
                    ...
                    >
                      ...
                      <s id="ComparePrice-product"
                        ><span class="money">£600.00</span></s
                      >
                      <span
                    ...
                    <div class="orderMsg" data-user="23" data-time="24">
                      ...
                      <strong class="items">5</strong> sold in last
                      <strong class="time">26</strong> hours
                    </div>
                  </div>
                  ...
                  <div id="quantity_message">
                    Hurry! Only <span class="items">4</span> left in stock.
                  </div>
                  <form
                    method="post"
                  ...
                  >
                    ...
                    >
                      <!-- <div class="product-form__item">
                        <label class="header"
                          >Color: <span class="slVariant">Red</span></label
                        >
                        <div
                          data-value="Red"
                        ...
                        <div
                          data-value="aqua"
                          class="swatch-element color aqua available"
                        >
                          <input
                            class="swatchInput"
                            id="swatch-0-aqua"
                          ...
                          <label
                            ...
                            for="swatch-0-aqua"
                            style="
                              background-image: url(assets/images/product-detail-page/variant1-5.jpg);
                            "
                            title="aqua"
                          ></label>
                        </div>
                        ...
                        >
                          ...
                          <label
                            ...
                            for="swatch-0-orange"
                            style="
                              background-image: url(assets/images/product-detail-page/variant1-6.jpg);
                            "
                            title="Orange"
                          ></label>
                        </div>
                    ...
                    >
                      <div class="product-form__item">
                        <label class="header"
                          >Size: <span class="slVariant">XS</span></label
                        >
                        <div
                          data-value="XS"
                  ...
                  <p id="freeShipMsg" class="freeShipMsg" data-price="199">
                    <i class="fa fa-truck" aria-hidden="true"></i> GETTING
                    CLOSER! ONLY
                    <b class="freeShip"
                      ><span
                        class="money"
                  ...
                  <p class="shippingMsg">
                    <i class="fa fa-clock-o" aria-hidden="true"></i> ESTIMATED
                  ...
                  <div class="userViewMsg" data-user="20" data-time="11000">
                    ...
                    <strong class="uersView">14</strong> PEOPLE ARE LOOKING FOR
                    THIS PRODUCT
                  </div>
                </div>
              </div>
                        ...
                        <div class="spr-summary">
                          <span class="product-review"
                            ><a class="reviewLink"
                              ...
                              ><i class="font-13 fa fa-star"></i
                              ><i class="font-13 fa fa-star-o"></i
                              ><i class="font-13 fa fa-star-o"></i> </a
                            ><span class="spr-summary-actions-togglereviews"
                              >Based on 6 reviews456</span
                            ></span
                          >
                          <span class="spr-summary-actions">
                            <a
                              href="#"
                              class="spr-summary-actions-newreview btn"
                              >Write a review</a
                            >
                          </span>
                        </div>
